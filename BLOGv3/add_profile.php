...
// If user id is found redirect to the edit_profile.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if(!is_string($fname_error) && !is_string($lname_error) && !is_string($date_error)
    && $aboutLength < 250){
      ...
      $stmt_profile->prepare("INSERT INTO Profile(user_id, first_name, last_name, gender, birth_date, about)
        VALUES (?,?,?,?,?,?)");
      $stmt_profile->bind_param("ssssss", $user_id, $fname, $lname, $gender, $birthDate,$about);
      ...
      if(!is_string($profile_pic_error)){
        ...
        $stmt_pic->prepare("INSERT INTO Profile_photos(user_id, pic_url) VALUES (?,?)");
        $stmt_pic->bind_param("ss", $user_id,$new_img_name);
        $stmt_pic->execute();
      }
      ...
      <form class="from" method="post" enctype="multipart/form-data">
        ...
        <?php if (isset($_SESSION['fname_error'])): ?>
          <div class="mb-3">
            ...
            <input type="text" class="form-control is-invalid" id="fname" name="fname">
        ...
        <?php if (isset($_SESSION['lname_error'])): ?>
          <div class="mb-3">
            ...
            <input type="text" id="lname" name="lname" class="form-control is-invalid">
            <div class="invalid-feedback">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="gender" value="None" hidden checked>
        </div>
        <!-- Male -->
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="gender" id="Male" value="Male"
            <?php echo $result = (isset($gender) && $gender === 'Male') ? 'checked' : '' ; ?>>
          <label class="form-check-label" for="Male"> Male </label>
        </div>
        <!-- Female -->
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="gender" id="Female" value="Female"
          <?php echo $result = (isset($gender) && $gender === 'Female') ? 'checked' : '' ; ?>>
          <label class="form-check-label" for="Female"> Female </label>
        </div>
        <!-- Other -->
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="gender" id="other" value="Other"
          <?php echo $result = (isset($gender) && $gender === 'Other') ? 'checked' : '' ; ?>>
        ...
        <div class="mb-3">
          <div class="input-group" style="margin-top: 25px">
            ...
            style="outline: none"><?php 
              echo $result = (isset($about) && strlen($about) > 0) ? $about : '' ; 
            ?></textarea>
          </div>
